...
@Component({
    ...
    templateUrl: './cip-05.component.html',
    styleUrls: ['./cip-05.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class Cip05Component implements OnInit {
    ...
    requireAuth(action: string): void {
        ...
        if (user) {
            ...
            console.log(`Action authentifiée (CIP-05) : ${action}`);
            return;
        }
    ...
    ngOnInit(): void {
        const cfg = getSeoFor('/certificats/cip-05');
        ...
        const jsonLd: any = {
            ...
            name:
                cfg?.title ??
                'CIP-05 — Certificat d’Intrication Persistante',
            url: cfg?.canonical,
        };
        ...
        this.seo.setMeta({
            ...
            description:
                cfg?.description ??
                "Certificat d’Intrication Persistante — JocKeCorp™. Documentant les corrélations persistantes entre deux consciences séparées.",
